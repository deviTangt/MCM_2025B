function [V, C] = C_Optimal_Bali(Emax, Imax, Smax, Vmax);
...
beta(1, 7) = 2.149;
    ...
    [V, C] = fmincon(cal_C, 1000, A, b, Aeq, beq, lb, ub, @(V)nonlcon(V, Smax), options);
    C = -C;
    
    if (Check_EISRC == 1)
        V_ = V;
         persistent alpha_VS;
        alpha_VS = [2.1003    3.4759   19.8652] * 160 / 1700;
         persistent EdgePoint;
        EdgePoint = [24150, 53520] * 1e-4 * 1700 / 160;
        % E，I，S验证
